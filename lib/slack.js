...
export default class SlackData extends EventEmitter {
  ...
  init (){
    ...
    this.org.name = 'Mind the Product';
    this.org.logo = 'https://s3-us-west-2.amazonaws.com/slack-files2/avatars/2015-08-20/9417194214_bbadf552549e3b59e4b1_132.jpg';
    this.users.total = 'Near 10,000';
    this.users.active = 0;    
  }
